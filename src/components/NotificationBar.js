  ...
  return (
    <NotifStyle show={store.showNotif}>
      <div className="flex justify-between">
        ...
        <button onClick={action({ type: "TOGGLE_NOTIF" })}>Close</button>
      </div>
      <div className="mt-5 -mx-2">
        ...
        <Alert type="warning" className="mb-1" icon={helpIcon} fullwidth>
          <span className="text-xs">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae quas
            tenetur consequatur voluptatum molestiae adipisci, autem,
            perspiciatis architecto blanditiis porro neque, ullam vero aliquam
            non inventore perferendis. Nam veritatis, eveniet.
          </span>
        </Alert>
      </div>
    </NotifStyle>
